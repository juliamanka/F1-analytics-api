...
{
    public Task<PagedResult<MeasurementDto>> GetFilteredMeasurementsPagedAsync(MeasurementFilterParameters filters);
    ...
    public Task<List<MeasurementDto>> GetFilteredMeasurementsAsync(MeasurementDashboardFilters filters);
}